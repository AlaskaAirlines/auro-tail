 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const a$1=Symbol.for(""),o$6=t=>{if(t?.r===a$1)return t?._$litStatic$},s$3=t=>({_$litStatic$:t,r:a$1}),i$4=(t,...r)=>({_$litStatic$:r.reduce(((r,e,a)=>r+(t=>{if(void 0!==t._$litStatic$)return t._$litStatic$;throw Error(`Value passed to 'literal' function must be a 'literal' result: ${t}. Use 'unsafeStatic' to pass non-literal values, but\n            take care to ensure page security.`)})(e)+t[a+1]),t[0]),r:a$1}),l$1=new Map,n$4=t=>(r,...e)=>{const a=e.length;let s,i;const n=[],u=[];let c,$=0,f=false;for(;$<a;){for(c=r[$];$<a&&void 0!==(i=e[$],s=o$6(i));)c+=s+r[++$],f=true;$!==a&&u.push(i),n.push(c),$++;}if($===a&&n.push(r[a]),f){const t=n.join("$$lit$$");void 0===(r=l$1.get(t))&&(n.raw=n,l$1.set(t,r=n)),e=u;}return t(r,...e)},u$3=n$4(x$1);
...
const OneWorld = () => x$1`<svg width="100%" height="100%" viewBox="0 0 55 55" fill="none" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
...
class AuroTail extends i$1 {
  ...
  constructor() {
     ...
     * @private
     */
    this.hyperlinkTag = versioning.generateTag("auro-hyperlink", hyperlinkVersion, be);
...
var groupStyleCss = i$3`:host{--ds-auro-tail-border-color: var(--ds-auro-tail-border-color-default);--ds-auro-tail-border-width: var(--ds-auro-tail-border-w-default)}:host{display:inline-block;width:var(--ds-auro-tail-container-w);height:var(--ds-auro-tail-container-w);min-width:var(--ds-auro-tail-container-w);min-height:var(--ds-auro-tail-container-w);--ds-auro-tail-container-w: var(--ds-auro-tail-container-w-lg);--ds-auro-tail-container-gradient: var(--ds-auro-tail-gradient-oa);--ds-auro-tail-tail-w: var(--ds-auro-tail-tail-w-lg);--ds-auro-tail-tail-offset-y: var(--ds-auro-tail-tail-offset-y-lg);--ds-auro-tail-href-label-gap: var(--ds-auro-tail-href-label-gap-lg);--ds-auro-tail-badge-w: var(--ds-auro-tail-badge-w-lg);--ds-auro-tail-border-color-default: rgba(88, 94, 103, 1);--ds-auro-tail-border-color-white: #ffffff;--ds-auro-tail-border-w-default: 0;--ds-auro-tail-border-display: none;--ds-auro-tail-border-padding: 0;--ds-auro-tail-border-radius-full: 999px;--ds-auro-tail-tail-outline-color: var(--ds-auro-tail-border-color-default);--ds-auro-tail-tail-outline-w: 1px;--ds-auro-tail-tail-drop-shadow: drop-shadow(0 3px 3px rgba(0,0,0,.24)) drop-shadow(0 6px 14px rgba(0,0,0,.24));--ds-auro-tail-z-index-border: 1;--ds-auro-tail-z-index-badge: 2;--ds-auro-tail-z-index-group-back: 1;--ds-auro-tail-z-index-group-front: 2;--ds-auro-tail-badge-offset-x: 0;--ds-auro-tail-badge-offset-y: 0;--ds-auro-tail-container-w-xs: 24px;--ds-auro-tail-tail-w-xs: 19px;--ds-auro-tail-tail-offset-y-xs: 3px;--ds-auro-tail-container-w-sm: 32px;--ds-auro-tail-tail-w-sm: 26px;--ds-auro-tail-tail-offset-y-sm: 4px;--ds-auro-tail-container-w-md: 48px;--ds-auro-tail-tail-w-md: 39px;--ds-auro-tail-tail-offset-y-md: 6px;--ds-auro-tail-href-label-gap-md: 2px;--ds-auro-tail-badge-w-md: 11px;--ds-auro-tail-badge-offset-x-md: 2px;--ds-auro-tail-badge-offset-y-md: -7px;--ds-auro-tail-container-w-lg: 60px;--ds-auro-tail-tail-w-lg: 48px;--ds-auro-tail-tail-offset-y-lg: 7px;--ds-auro-tail-href-label-gap-lg: 4px;--ds-auro-tail-badge-w-lg: 14px;--ds-auro-tail-badge-offset-x-lg: 2px;--ds-auro-tail-badge-offset-y-lg: -4px;--ds-auro-tail-container-w-xl: 96px;--ds-auro-tail-tail-w-xl: 77px;--ds-auro-tail-tail-offset-y-xl: 13px;--ds-auro-tail-href-label-gap-xl: 6px;--ds-auro-tail-badge-w-xl: 22px;--ds-auro-tail-container-w-2xl: 134px;--ds-auro-tail-tail-w-2xl: 107px;--ds-auro-tail-tail-offset-y-2xl: 17px;--ds-auro-tail-href-label-gap-2xl: 8px;--ds-auro-tail-badge-w-2xl: 31px;--ds-auro-tail-group-diag-w-xs: 42px;--ds-auro-tail-group-horiz-border-w-xs: 3px;--ds-auro-tail-group-horiz-overlap-xs: -2px;--ds-auro-tail-group-diag-w-sm: 56px;--ds-auro-tail-group-horiz-border-w-sm: 3px;--ds-auro-tail-group-horiz-overlap-sm: -2px;--ds-auro-tail-group-diag-w-md: 84px;--ds-auro-tail-group-horiz-border-w-md: 4px;--ds-auro-tail-group-horiz-overlap-md: -6px;--ds-auro-tail-group-diag-w-lg: 105px;--ds-auro-tail-group-horiz-border-w-lg: 4px;--ds-auro-tail-group-horiz-overlap-lg: -10px;--ds-auro-tail-gradient-as: linear-gradient(180deg, #6899C6 0%, #CFE0EF 100%);--ds-auro-tail-gradient-ha: linear-gradient(181deg, #CCB7ED -6.38%, #F9C2E7 99.46%);--ds-auro-tail-gradient-oa: linear-gradient(181deg, #C5D0D9 -6.38%, #E8F1F8 99.46%)}:host([size=xs]){--ds-auro-tail-container-w: var(--ds-auro-tail-container-w-xs);--ds-auro-tail-tail-w: var(--ds-auro-tail-tail-w-xs);--ds-auro-tail-tail-offset-y: var(--ds-auro-tail-tail-offset-y-xs)}:host([size=sm]){--ds-auro-tail-container-w: var(--ds-auro-tail-container-w-sm);--ds-auro-tail-tail-w: var(--ds-auro-tail-tail-w-sm);--ds-auro-tail-tail-offset-y: var(--ds-auro-tail-tail-offset-y-sm)}:host([size=md]){--ds-auro-tail-container-w: var(--ds-auro-tail-container-w-md);--ds-auro-tail-tail-w: var(--ds-auro-tail-tail-w-md);--ds-auro-tail-tail-offset-y: var(--ds-auro-tail-tail-offset-y-md);--ds-auro-tail-badge-w: var(--ds-auro-tail-badge-w-md);--ds-auro-tail-badge-offset-x: var(--ds-auro-tail-badge-offset-x-md, 0);--ds-auro-tail-badge-offset-y: var(--ds-auro-tail-badge-offset-y-md, 0);--ds-auro-tail-href-label-gap: var(--ds-auro-tail-href-label-gap-md)}:host([size=lg]){--ds-auro-tail-container-w: var(--ds-auro-tail-container-w-lg);--ds-auro-tail-tail-w: var(--ds-auro-tail-tail-w-lg);--ds-auro-tail-tail-offset-y: var(--ds-auro-tail-tail-offset-y-lg);--ds-auro-tail-badge-w: var(--ds-auro-tail-badge-w-lg);--ds-auro-tail-badge-offset-x: var(--ds-auro-tail-badge-offset-x-lg, 0);--ds-auro-tail-badge-offset-y: var(--ds-auro-tail-badge-offset-y-lg, 0);--ds-auro-tail-href-label-gap: var(--ds-auro-tail-href-label-gap-lg)}:host([size=xl]){--ds-auro-tail-container-w: var(--ds-auro-tail-container-w-xl);--ds-auro-tail-tail-w: var(--ds-auro-tail-tail-w-xl);--ds-auro-tail-tail-offset-y: var(--ds-auro-tail-tail-offset-y-xl);--ds-auro-tail-badge-w: var(--ds-auro-tail-badge-w-xl);--ds-auro-tail-badge-offset-x: var(--ds-auro-tail-badge-offset-x-xl, 0);--ds-auro-tail-badge-offset-y: var(--ds-auro-tail-badge-offset-y-xl, 0);--ds-auro-tail-href-label-gap: var(--ds-auro-tail-href-label-gap-xl)}:host([size="2xl"]){--ds-auro-tail-container-w: var(--ds-auro-tail-container-w-2xl);--ds-auro-tail-tail-w: var(--ds-auro-tail-tail-w-2xl);--ds-auro-tail-tail-offset-y: var(--ds-auro-tail-tail-offset-y-2xl);--ds-auro-tail-badge-w: var(--ds-auro-tail-badge-w-2xl);--ds-auro-tail-badge-offset-x: var(--ds-auro-tail-badge-offset-x-2xl, 0);--ds-auro-tail-badge-offset-y: var(--ds-auro-tail-badge-offset-y-2xl, 0);--ds-auro-tail-href-label-gap: var(--ds-auro-tail-href-label-gap-2xl)}:host([tail=as i]){--ds-auro-tail-container-gradient: var(--ds-auro-tail-gradient-as)}:host([tail=ha i]){--ds-auro-tail-container-gradient: var(--ds-auro-tail-gradient-ha)}:host([tail=oa i]){--ds-auro-tail-container-gradient: var(--ds-auro-tail-gradient-oa)}:host([layout=horizontal][size=xs]){width:calc(2 * var(--ds-auro-tail-container-w-xs) + 2 * var(--ds-auro-tail-group-horiz-border-w-xs) + var(--ds-auro-tail-group-horiz-overlap-xs));height:calc(var(--ds-auro-tail-container-w-xs) + 2 * var(--ds-auro-tail-group-horiz-border-w-xs));min-height:calc(var(--ds-auro-tail-container-w-xs) + 2 * var(--ds-auro-tail-group-horiz-border-w-xs))}:host([layout=horizontal][size=sm]){width:calc(2 * var(--ds-auro-tail-container-w-sm) + 2 * var(--ds-auro-tail-group-horiz-border-w-sm) + var(--ds-auro-tail-group-horiz-overlap-sm));height:calc(var(--ds-auro-tail-container-w-sm) + 2 * var(--ds-auro-tail-group-horiz-border-w-sm));min-height:calc(var(--ds-auro-tail-container-w-sm) + 2 * var(--ds-auro-tail-group-horiz-border-w-sm))}:host([layout=horizontal][size=md]){width:calc(2 * var(--ds-auro-tail-container-w-md) + 2 * var(--ds-auro-tail-group-horiz-border-w-md) + var(--ds-auro-tail-group-horiz-overlap-md));height:calc(var(--ds-auro-tail-container-w-md) + 2 * var(--ds-auro-tail-group-horiz-border-w-md));min-height:calc(var(--ds-auro-tail-container-w-md) + 2 * var(--ds-auro-tail-group-horiz-border-w-md))}:host([layout=horizontal][size=lg]){width:calc(2 * var(--ds-auro-tail-container-w-lg) + 2 * var(--ds-auro-tail-group-horiz-border-w-lg) + var(--ds-auro-tail-group-horiz-overlap-lg));height:calc(var(--ds-auro-tail-container-w-lg) + 2 * var(--ds-auro-tail-group-horiz-border-w-lg));min-height:calc(var(--ds-auro-tail-container-w-lg) + 2 * var(--ds-auro-tail-group-horiz-border-w-lg))}:host{--ds-auro-tail-group-border-color: var(--ds-auro-tail-border-color)}:host([layout=horizontal]){--ds-auro-tail-border-color: var(--ds-auro-tail-border-color-white);--ds-auro-tail-group-border-color: var(--ds-auro-tail-border-color)}.group{display:inline-flex;position:relative}.group.horizontal{gap:0}:host([layout=horizontal]) .group.horizontal ::slotted(auro-tail),:host([layout=horizontal]) .group.horizontal ::slotted([auro-tail]){position:relative;--ds-auro-tail-border-color: var(--ds-auro-tail-group-border-color, var(--ds-auro-tail-border-color-white))}:host([layout=horizontal][size=xs]) .group.horizontal ::slotted(auro-tail),:host([layout=horizontal][size=xs]) .group.horizontal ::slotted([auro-tail]){--ds-auro-tail-border-width: var(--ds-auro-tail-group-horiz-border-w-xs);width:calc(var(--ds-auro-tail-container-w-xs) + 2 * var(--ds-auro-tail-group-horiz-border-w-xs));min-width:calc(var(--ds-auro-tail-container-w-xs) + 2 * var(--ds-auro-tail-group-horiz-border-w-xs))}:host([layout=horizontal][size=xs]) .group.horizontal ::slotted(auro-tail:first-child),:host([layout=horizontal][size=xs]) .group.horizontal ::slotted([auro-tail]:first-child){margin-right:calc(var(--ds-auro-tail-group-horiz-overlap-xs) - 2 * var(--ds-auro-tail-group-horiz-border-w-xs))!important;z-index:var(--ds-auro-tail-z-index-group-front)}:host([layout=horizontal][size=sm]) .group.horizontal ::slotted(auro-tail),:host([layout=horizontal][size=sm]) .group.horizontal ::slotted([auro-tail]){--ds-auro-tail-border-width: var(--ds-auro-tail-group-horiz-border-w-sm);width:calc(var(--ds-auro-tail-container-w-sm) + 2 * var(--ds-auro-tail-group-horiz-border-w-sm));min-width:calc(var(--ds-auro-tail-container-w-sm) + 2 * var(--ds-auro-tail-group-horiz-border-w-sm))}:host([layout=horizontal][size=sm]) .group.horizontal ::slotted(auro-tail:first-child),:host([layout=horizontal][size=sm]) .group.horizontal ::slotted([auro-tail]:first-child){margin-right:calc(var(--ds-auro-tail-group-horiz-overlap-sm) - 2 * var(--ds-auro-tail-group-horiz-border-w-sm))!important;z-index:var(--ds-auro-tail-z-index-group-front)}:host([layout=horizontal][size=md]) .group.horizontal ::slotted(auro-tail),:host([layout=horizontal][size=md]) .group.horizontal ::slotted([auro-tail]){--ds-auro-tail-border-width: var(--ds-auro-tail-group-horiz-border-w-md);width:calc(var(--ds-auro-tail-container-w-md) + 2 * var(--ds-auro-tail-group-horiz-border-w-md));min-width:calc(var(--ds-auro-tail-container-w-md) + 2 * var(--ds-auro-tail-group-horiz-border-w-md))}:host([layout=horizontal][size=md]) .group.horizontal ::slotted(auro-tail:first-child),:host([layout=horizontal][size=md]) .group.horizontal ::slotted([auro-tail]:first-child){margin-right:calc(var(--ds-auro-tail-group-horiz-overlap-md) - 2 * var(--ds-auro-tail-group-horiz-border-w-md))!important;z-index:var(--ds-auro-tail-z-index-group-front)}:host([layout=horizontal][size=lg]) .group.horizontal ::slotted(auro-tail),:host([layout=horizontal][size=lg]) .group.horizontal ::slotted([auro-tail]){--ds-auro-tail-border-width: var(--ds-auro-tail-group-horiz-border-w-lg);width:calc(var(--ds-auro-tail-container-w-lg) + 2 * var(--ds-auro-tail-group-horiz-border-w-lg));min-width:calc(var(--ds-auro-tail-container-w-lg) + 2 * var(--ds-auro-tail-group-horiz-border-w-lg))}:host([layout=horizontal][size=lg]) .group.horizontal ::slotted(auro-tail:first-child),:host([layout=horizontal][size=lg]) .group.horizontal ::slotted([auro-tail]:first-child){margin-right:calc(var(--ds-auro-tail-group-horiz-overlap-lg) - 2 * var(--ds-auro-tail-group-horiz-border-w-lg))!important;z-index:var(--ds-auro-tail-z-index-group-front)}:host([layout=horizontal]) .group.horizontal ::slotted(auro-tail:last-child),:host([layout=horizontal]) .group.horizontal ::slotted([auro-tail]:last-child){z-index:var(--ds-auro-tail-z-index-group-back)}:host([layout=diagonal][size=xs]){width:var(--ds-auro-tail-group-diag-w-xs);height:var(--ds-auro-tail-group-diag-w-xs)}:host([layout=diagonal][size=xs]) .group.diagonal{width:var(--ds-auro-tail-group-diag-w-xs);height:var(--ds-auro-tail-group-diag-w-xs)}:host([layout=diagonal][size=sm]){width:var(--ds-auro-tail-group-diag-w-sm);height:var(--ds-auro-tail-group-diag-w-sm)}:host([layout=diagonal][size=sm]) .group.diagonal{width:var(--ds-auro-tail-group-diag-w-sm);height:var(--ds-auro-tail-group-diag-w-sm)}:host([layout=diagonal][size=md]){width:var(--ds-auro-tail-group-diag-w-md);height:var(--ds-auro-tail-group-diag-w-md)}:host([layout=diagonal][size=md]) .group.diagonal{width:var(--ds-auro-tail-group-diag-w-md);height:var(--ds-auro-tail-group-diag-w-md)}:host([layout=diagonal][size=lg]){width:var(--ds-auro-tail-group-diag-w-lg);height:var(--ds-auro-tail-group-diag-w-lg)}:host([layout=diagonal][size=lg]) .group.diagonal{width:var(--ds-auro-tail-group-diag-w-lg);height:var(--ds-auro-tail-group-diag-w-lg)}:host([layout=diagonal]) .group.diagonal ::slotted(auro-tail),:host([layout=diagonal]) .group.diagonal ::slotted([auro-tail]){position:absolute;--ds-auro-tail-border-color: transparent;--ds-auro-tail-border-width: 0;--ds-auro-tail-border-padding: 0}.group.diagonal ::slotted(auro-tail:first-child),.group.diagonal ::slotted([auro-tail]:first-child){top:0;left:0;z-index:var(--ds-auro-tail-z-index-group-front)}.group.diagonal ::slotted(auro-tail:nth-child(2)),.group.diagonal ::slotted([auro-tail]:nth-child(2)){bottom:0;right:0;z-index:var(--ds-auro-tail-z-index-group-back)}
`;
