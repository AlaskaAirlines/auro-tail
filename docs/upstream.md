...
```bash
origin  https://github.com/[yourUserName]/auro-tail.git (fetch)
origin  https://github.com/[yourUserName]/auro-tail.git (push)
```

To add the upstream repo to your local forked project

```bash
$ git remote add upstream https://github.com/AlaskaAirlines/auro-tail.git
```
...
origin  https://github.com/[yourUserName]/auro-tail.git (fetch)
origin  https://github.com/[yourUserName]/auro-tail.git (push)
upstream        https://github.com/AlaskaAirlines/auro-tail.git (fetch)
upstream        https://github.com/AlaskaAirlines/auro-tail.git (push)
```
